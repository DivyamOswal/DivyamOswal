...
Building scalable applications and production-ready backend systems.
...
- 🚀 Building full-stack applications with **Next.js, TypeScript & Node.js**
- 🗄️ Working with **SQL & NoSQL databases**
- ☁️ Exploring **AWS, Docker & scalable backend architecture**
...
### 🩺 [Connect2Cure](https://github.com/DivyamOswal/connect2cure)

Telemedicine platform with real-time video consultations and patient-doctor workflows.

**React • Node.js • MongoDB • WebRTC**

### 👥 [WorkSphere](https://github.com/DivyamOswal/worksphere)

Employee management system with CRUD operations, role-based access and audit logs.

**React • Node.js • Express • MongoDB**

### 🏨 [EaseWithStay](https://github.com/DivyamOswal/easewithstay)

Responsive hotel booking platform with a clean multi-step booking experience.
...
<img src="https://streak-stats.demolab.com/?user=DivyamOswal&theme=tokyonight&hide_border=true" />

<br/>

<img src="https://github-readme-activity-graph.vercel.app/graph?username=DivyamOswal&theme=tokyo-night&hide_border=true" width="95%" />
